	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				...
				<li><a href="index.php"><span style="font-weight: bold;text-decoration: underline;"></span> Product</a></li>
				<li><a href="logout.php"><span  style="font-weight: bold;text-decoration: underline; margin-left:1100px"></span> LOGOUT</a></li>
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="#" id="cart_container" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span> Cart <span class="badge">0</span></a>
					...
					<ul class="dropdown-menu">
						<li><a href="cart.php" style="text-decoration:none; color:black;"><span > Cart</a></li>
						<li class="divider"></li>
		...
		<div class="row">
			...
			<div class="col-md-8">	
				...
				<div class="panel panel-info" id="scroll">
					...
					<div class="panel-footer">LAMKIRICH &copy; <?php echo date("Y"); ?></div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
